...
public class Chessboard {
	...
	class Field {
		...
		/**
		 * Constructor for a specific field (title), its actions and properties.
		 *  row is the row in the chessboard
		 *  column is the coloumn in the chessboard
		 */
		...
		/**
		 * Position a specific chess piece on the field setting the "piece" variable of
		 * field. piece the type of the piece
		 */
		...
		/**
		 * Remove the piece present on the field setting the "piece" variable to null.
		 * 
		...
		/**
		 * Set the variable "marked" to true when a field is marked by a chess piece.
		 */
		private void mark() {
			this.marked = true;
		}
		...
		/**
		 * Set the variable "marked" to false when a field is not marked by a chess
		 * piece.
		 */
		private void unmark() {
			this.marked = false;
		...
		/**
		 * Return string "xx" if the field is marked, Return string "--" if it is not
		 * marked.
		 */
	...
	/**
	 * Create the two dimensional array chessboard. The arrays are filled creating
	 * elements of the type fields with suitable row and column properties.
	 */
	public Chessboard() {
	...
	/**
	 * Print configuration of the chessboard with rows and columns, marked and
	 * unmarked fields. Makes use of StringBuilder.
	 * 
	...
	/**
	 * Evaluates if two coordinates (row and column) define a valid field contained
	 * in the chessboard.
	 * 
	 * row of the field column of the field return true if field is valid, else
	 * false
	 */
	...
	public abstract class Chesspiece {
		 ...
		 * 
		 * color of the piece (white or black) name is the type of the piece
		 */
		...
		/**
		 * "Move" a piece to a specific field. The element is copied to the field and
		 * the original remains.
		 * 
		 * row of the target field column of the target field throws
